...
xdd_func_t  xdd_func[] = {
    ...
    {"endtoend", "e2e",
            xddfunc_endtoend,
            1,
            "  -endtoend [target #]  issource | isdestination | islocal | destination <hostname[:baseport#[,portcount]]> | destination <file_name> | port <#> | portcount <#>\n",
            {"    Specifies a source and destination information for doing end-to-end test between two machines or local file duplication on the same machine",
            0,0,0,0},
			0},
    {"errout", "eo",
            xddfunc_errout,
